...
from union_closed_tight_m18.certificates import build_certificate, verify_certificate
from union_closed_tight_m18.encoding import build_cnf


def parser() -> argparse.ArgumentParser:
    root = argparse.ArgumentParser(description="Order-eight, m=18 clean-tight gate")
...
def main() -> None:
    ...
    if arguments.command == "certify":
        ...
        print("order=8, m=18: DRAT+LRAT built and VERIFIED")
        return
    verify_certificate(
        arguments.manifest,
        arguments.drat_checker,
    ...
    print("order=8, m=18: retained DRAT+LRAT VERIFIED")
