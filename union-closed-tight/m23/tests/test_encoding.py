...
from union_closed_tight_m23.encoding import (
    TARGET,
    Parameters,
    build_cnf,
    family_variable,
)
from union_closed_tight_m23.semantics import (
    element_frequencies,
    is_canonical_clean_tight,
)


def test_public_target_is_exactly_order_eight_m23() -> None:
    assert Parameters(order=8, member_count=23) == TARGET
