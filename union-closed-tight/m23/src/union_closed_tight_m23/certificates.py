...
from union_closed_tight_m23.encoding import TARGET, build_cnf
...
def build_certificate(
    ...
    cnf_path = work_directory / "order8-members23.cnf"
    ...
    drat_destination = manifest_path.parent / "order8-members23.drat.xz"
    lrat_destination = manifest_path.parent / "order8-members23.lrat.xz"
