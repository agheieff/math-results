...
from union_closed_tight_m22.encoding import TARGET, build_cnf
...
def build_certificate(
    ...
    cnf_path = work_directory / "order8-members22.cnf"
    ...
    drat_destination = manifest_path.parent / "order8-members22.drat.xz"
    lrat_destination = manifest_path.parent / "order8-members22.lrat.xz"
