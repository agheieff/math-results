...
from union_closed_tight_m20.certificates import build_certificate, verify_certificate
from union_closed_tight_m20.encoding import build_cnf


def parser() -> argparse.ArgumentParser:
    root = argparse.ArgumentParser(description="Order-eight, m=20 clean-tight gate")
...
def main() -> None:
    ...
    if arguments.command == "certify":
        ...
        print("order=8, m=20: DRAT+LRAT built and VERIFIED")
        return
    verify_certificate(
        arguments.manifest,
        arguments.drat_checker,
    ...
    print("order=8, m=20: retained DRAT+LRAT VERIFIED")
