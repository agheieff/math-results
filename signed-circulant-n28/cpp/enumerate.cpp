...
constexpr std::uint32_t n = 28;
constexpr std::uint32_t class_bits = 29;
constexpr std::uint32_t class_count = 1U << class_bits;
constexpr int fast_max_k = 13;
constexpr int big_max_k = 40;
constexpr std::int64_t separator_numerator = 969;
constexpr std::int64_t separator_denominator = 125;
...
int main() {
    ...
    std::cout << "{\n";
    std::cout << "  \"n\":28,\n";
    std::cout << "  \"class_bits\":29,\n";
    std::cout << "  \"class_count\":" << class_count << ",\n";
    std::cout << "  \"separator_square\":\"969/125\",\n";
