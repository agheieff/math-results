...
from union_closed_tight_m16.encoding import TARGET, build_cnf
...
def _compress(source: Path, destination: Path) -> CompressedArtifact:
    ...
    with source.open("rb") as input_stream, lzma.open(destination, "wb", preset=6) as output_stream:
...
def build_certificate(
    ...
    cnf_path = work_directory / "order8-members16.cnf"
    ...
    drat_destination = manifest_path.parent / "order8-members16.drat.xz"
    lrat_destination = manifest_path.parent / "order8-members16.lrat.xz"
