...
from union_closed_tight_m16.certificates import build_certificate, verify_certificate
from union_closed_tight_m16.encoding import build_cnf


def parser() -> argparse.ArgumentParser:
    root = argparse.ArgumentParser(description="Order-eight, m=16 clean-tight gate")
...
def main() -> None:
    ...
    if arguments.command == "certify":
        ...
        print("order=8, m=16: DRAT+LRAT built and VERIFIED")
        return
    verify_certificate(
        arguments.manifest,
        arguments.drat_checker,
    ...
    print("order=8, m=16: retained DRAT+LRAT VERIFIED")
