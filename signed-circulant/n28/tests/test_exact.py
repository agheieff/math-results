...
from signed_circulant_n28.exact import (
...
from signed_circulant_n28.model import TARGET_MASKS, matrix_from_mask
...
def test_target_algebra_and_sturm_isolation() -> None:
    verify_target_algebra()
    assert roots_between(Fraction(7), Fraction(SEPARATOR_NUMERATOR, SEPARATOR_DENOMINATOR)) == 1
