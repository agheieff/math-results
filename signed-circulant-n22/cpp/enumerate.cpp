...
constexpr std::uint32_t n = 22;
constexpr std::uint32_t class_bits = 23;
constexpr std::uint32_t class_count = 1U << class_bits;
constexpr int fast_max_k = 13;
constexpr int big_max_k = 26;
constexpr std::int64_t separator_numerator = 3801;
constexpr std::int64_t separator_denominator = 500;
...
int main() {
    ...
    std::cout << "{\n";
    std::cout << "  \"n\":22,\n";
    std::cout << "  \"class_bits\":23,\n";
    std::cout << "  \"class_count\":" << class_count << ",\n";
    std::cout << "  \"separator_square\":\"3801/500\",\n";
